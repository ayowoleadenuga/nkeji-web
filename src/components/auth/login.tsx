...
const Login: React.FC<LoginInterface> = ({ closeModal, setCurrentTab }) => {
  ...
  return (
    <div className="w-full h-[80vh]  relative flex justify-between ">
      <button
      ...
      {loginTab === "login" ? (
        <div className="flex items-center justify-center w-full  md:w-[61.5%] h-[100%] ">
          <div>
