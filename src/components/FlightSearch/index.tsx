...

    {
         ...
         <div className="w-full py-5">
          ...
          <div className="bg-[#F7F8F9] px-6 py-5 lg:px-20 mt-10 flex justify-between">
            ...
            <ContactDetails showDetails setCurrentTab={setCurrentTab} index={2}/>
      ...
      }
       {
         ...
         <div className="w-full py-5">
          ...
          <div className="bg-[#F7F8F9] px-6 py-5 lg:px-20 mt-10 flex justify-between">
            ...
            <ContactDetails showDetails setCurrentTab={setCurrentTab} index={3}/>
...

      {
        currentTab >= 1 &&
         <div className="flex justify-center space-x-3 mt-6">
            ...
            className="rounded-full px-14 py-3 border border-[#7F56D9] bg-white text-sm inter-semibold">Back</button>
            <button 
            onClick={()=>setCurrentTab(currentTab + 1)}
            type="button"
            
            className="rounded-full px-14 py-3 bg-[#7F56D9] text-white text-sm inter-semibold">{ currentTab === 3 ?'Make payment' :'Next'}</button>
            </div>
      }
      <CustomerBenefits />
      <FAQS />
